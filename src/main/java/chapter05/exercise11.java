...
public class exercise11 {
	public static void main(String... args) {
		...
		Function<List<Double>, Double> sum = l -> foldLeft(l, 0D, x -> y -> x + y);
		Function<List<Double>, Double> product = l -> foldLeft(l, 1D, x -> y -> x * y);
		Function<List<Double>, Integer> length = l -> foldLeft(l, 0, __ -> y -> y + 1);

		System.out.println(sum.apply(list));
		System.out.println(product.apply(list));
		System.out.println(length.apply(list));
	}
