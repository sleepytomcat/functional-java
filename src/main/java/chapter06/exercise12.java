...
public class exercise12 {
	public static void main(String... args) {
		System.out.println(traverse(ListUtils.List.list(1, 3, 5, 7), x -> x % 2 == 0? Option.none() : Option.some(x.toString())));
		System.out.println(traverse(ListUtils.List.list(1, 2, 3, 4, 5, 6, 7), x -> x % 2 == 0? Option.none() : Option.some(x.toString())));
	}

	public static <A,B> Option<ListUtils.List<B>> traverse(ListUtils.List<A> list, Function<A, Option<B>> f) {
