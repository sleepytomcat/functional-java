...
public class exercise10 {
	public static void main(String... args) {
		Result.empty().forEachOrThrow(x -> System.out.println(x));
		Result.success(42).forEachOrThrow(x -> System.out.println(x));
		Result.failure("some error").forEachOrThrow(x -> System.out.println(x)); // expected to throw exception
	}
