...
public class exercise13 {
	public static void main(String... args) {
		Function<Result<Integer>, Function<Result<Double>, Result<String>>>
				lifted2 = lift2((Integer x) -> (Double y) -> "[" + String.valueOf(x / y) + "]");


		lifted2
				.apply(Result.success(42))
				.apply(Result.success(2d))
				.forEach(System.out::println);

		lifted2
				.apply(Result.success(42))
				.apply(Result.failure("no value"))
				.forEach(System.out::println);
		...
		Function<Result<Integer>, Function<Result<Integer>, Function<Result<Integer>, Result<String>>>>
				lifted3 = lift3((Integer x) -> (Integer y) -> (Integer z) -> "[" + String.valueOf(x + y + z) + "]");

		lifted3
				.apply(Result.success(42))
				.apply(Result.success(2))
				.apply(Result.success(3))
				.forEach(System.out::println);
	}
